...
This is a mini course about R programming language with some useful and important functions that we need to know before we learn more advanced and tricky functions. I hope you enjoy it and please feel free to ask any question. 
...
We use Laplace approximation to find the posterior mean and posterior variance for \(\eta\).
